/// Auto-generated unreflector glue for LogicalFunction::Year_Of.
...
namespace
{
const auto registered_Year_Of_LogicalFunction = [] {
    ...
    if (!registered)
    {
        ...
        throw std::runtime_error{std::string{"Duplicate unreflection registration for \"Year_Of\" in LogicalFunction"}};
    }
    return 0;
}();
}

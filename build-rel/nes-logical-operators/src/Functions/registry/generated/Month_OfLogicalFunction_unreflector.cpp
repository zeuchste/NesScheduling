/// Auto-generated unreflector glue for LogicalFunction::Month_Of.
...
namespace
{
const auto registered_Month_Of_LogicalFunction = [] {
    ...
    if (!registered)
    {
        ...
        throw std::runtime_error{std::string{"Duplicate unreflection registration for \"Month_Of\" in LogicalFunction"}};
    }
    return 0;
}();
}

...
public:
    ...
    [[nodiscard]] nautilus::engine::CompiledFunction<void(TupleBuffer*, TupleBuffer*, uint64_t, AbstractBufferProvider*, HashMap*)>
    ...
    [[nodiscard]] nautilus::engine::CompiledFunction<void(TupleBuffer*, uint64_t, TupleBuffer*, AbstractBufferProvider*, HashMap*)>
